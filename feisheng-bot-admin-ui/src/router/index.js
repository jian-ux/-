...
const routes = [
  { path: '/login', component: () => import('../views/login/index.vue') },
  {
    ...
    children: [
      ...
      { path: 'knowledge/faq', component: () => import('../views/knowledge/FaqList.vue'), meta: { title: '常见问题管理' } },
      { path: 'knowledge/semantic-units', component: () => import('../views/knowledge/SemanticUnits.vue'), meta: { title: '结构化知识审核' } },
      ...
      { path: 'knowledge/upload', component: () => import('../views/knowledge/Upload.vue'), meta: { title: '知识库上传' } },
      ...
      { path: 'knowledge/unmatched', component: () => import('../views/knowledge/UnmatchedList.vue'), meta: { title: '未命中问题' } },
